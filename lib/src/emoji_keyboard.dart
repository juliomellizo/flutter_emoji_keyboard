...
class EmojiKeyboard extends StatefulWidget {
  ...
  final bool darkMode;
  final Function(String)? onEmojiSelected; // Añadir este parámetro
  ...
  EmojiKeyboard({
    ...
    this.darkMode = false,
    this.onEmojiSelected, // Inicializar el callback
  }) : super(key: key);
...
class EmojiBoard extends State<EmojiKeyboard> {
  ...
  /// Esta función maneja los cambios en la página Emoji si el usuario desliza el dedo
  /// hacia la izquierda o hacia la derecha.
  /// Envía un disparador a la barra de categorías para actualizar la categoría.
